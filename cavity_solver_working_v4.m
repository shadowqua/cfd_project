function [PrsMatrix, uvelMatrix, vvelMatrix] = cavity_solver_working_v4(~)
...
loglog(h,rL1norm(:,1),'-o',h,rL2norm(:,1),'-o',h,rLinfnorm(:,1),'-o',h,rL1norm(:,2),'-o',h,rL2norm(:,2),'-o',h,rLinfnorm(:,2),'-o',h,rL1norm(:,3),'-o',h,rL2norm(:,3),'-o',h,rLinfnorm(:,3),'-o')
legend('rL1 for p','rL2 for p','rLinf for p','rL1 for u','rL2 for u','rLinf for u','rL1 for v','rL2 for v','rLinf for v')


%phat=ln(errork2/errork1)/ln(k2/k1)
%getting .01 phat from an r of 1.2??
