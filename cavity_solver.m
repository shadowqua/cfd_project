...
for j=3:jmax-2
    artviscx(2,j)=2*artviscx(3,j)-artviscx(4,j);
    artviscx(imax-1,j)=2*artviscx(imax-2,j)-artviscx(imax-3,j);

end

for i=3:imax-2
    artviscy(i,2)=2*artviscy(i,3)-artviscy(i,4);
    artviscy(i,jmax-1)=2*artviscy(i,jmax-2)-artviscy(i,jmax-3);

end

artviscx(2,2)=2*artviscx(3,2)-artviscx(4,2);
artviscx(imax-1,jmax-1)=2*artviscx(imax-2,jmax-1)-artviscx(imax-3,jmax-1);

artviscy(2,2)=2*artviscy(2,3)-artviscy(2,4);
artviscy(imax-1,jmax-1)=2*artviscy(imax-1,jmax-2)-artviscy(imax-1,jmax-3);
